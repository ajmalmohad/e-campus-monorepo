    ...
    <div className='h-full min-h-[100vh] w-full p-4 border-r-2 flex flex-col space-between'>
        <div className='h-full'>
          ...
          <div className='py-2 bg-blue'>
              ...
              <Link to="/placements"><div className='cursor-pointer flex items-center p-4 rounded hover:bg-[#695dff] hover:text-white font-medium'> <IoIosCreate className='mr-2'/>Placements</div></Link>
