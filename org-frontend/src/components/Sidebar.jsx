...
function Sidebar() {
  return (
    <div className='h-full min-h-[100vh] w-full p-4 border-r-2'>
        <div className='flex px-2 pb-4 items-center'><img src={Logo} className='h-[30px]'/></div>
        {/* <div className='flex px-2 items-center'><img src={Logo} className='h-[30px]'/><h1 className='p-2'>E Campus</h1></div> */}
